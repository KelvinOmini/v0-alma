  ...
  return (
    <div className="relative isolate overflow-hidden bg-gradient-to-b from-blue-50 to-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Assignment Helper</h1>
        <p className="mt-6 text-lg leading-8 text-gray-600">
          Your personal writing assistant that guides you through every stage of the academic writing process, from
          research and planning to drafting, editing, and citation.
        </p>
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Button asChild size="lg" className="rounded-md px-6 bg-blue-600 hover:bg-blue-700">
            <Link href="/dashboard">

  ...
  return (
    <div className="relative isolate overflow-hidden bg-gradient-to-b from-blue-50 to-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">About ALMA</h1>
        <p className="mt-6 text-lg leading-8 text-gray-600">
          We're on a mission to transform education and productivity through AI-powered assistance that adapts to each
          user's unique needs and learning style.
        </p>

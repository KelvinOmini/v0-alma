      ...
      <div className="container mx-auto px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          ...
          <p className="mt-4 text-center text-xs leading-5 text-gray-500 md:text-left">
            &copy; 2024 ALMA AI. All rights reserved.
          </p>
        </div>
      </div>
      <div className="border-t border-gray-900/10">
        <div className="container mx-auto flex flex-col items-center justify-between px-6 py-4 md:flex-row lg:px-8">
          ...
          <p className="mt-4 text-xs leading-5 text-gray-500 md:mt-0">Made with ❤️ for education and productivity</p>
        </div>
      </div>
    </footer>
  )

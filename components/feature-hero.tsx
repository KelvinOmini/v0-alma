    ...
    <div className="relative isolate overflow-hidden bg-gradient-to-b from-blue-50 to-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          Powerful Features for Learning & Productivity
        </h1>
        <p className="mt-6 text-lg leading-8 text-gray-600">
          Discover how ALMA's AI-powered platform can transform your academic journey, career development, and personal
          growth with specialized agents and advanced capabilities.
        </p>
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <Button variant="outline" asChild size="lg" className="rounded-md px-6">
            <Link href="#feature-comparison">Compare Features</Link>
          </Button>
        </div>
      </div>
    </div>
